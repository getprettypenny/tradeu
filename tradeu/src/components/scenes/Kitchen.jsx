...
export const hotspots = [
  {
    ...
    isViolation: true,
    explanation:
      'Any outlet within 6 ft of a kitchen sink needs GFCI protection. A standard outlet here is a shock hazard (NEC 210.8).',
    cx: 128,
    cy: 285,
  },
  {
    ...
    isViolation: true,
    explanation:
      'A power strip plugged into another power strip can overload the circuit — a real fire hazard. Run a dedicated circuit instead (NEC 210.52).',
    cx: 258,
    cy: 300,
  },
  {
    ...
    isViolation: false,
    explanation: 'GFCI-protected and mounted clear of the sink splash zone — this one is correctly installed.',
    cx: 190,
    cy: 285,
  },
  {
    ...
    label: 'Light switch',
    isViolation: false,
    explanation: "A standard switch is fine here — it's just controlling the overhead light.",
    cx: 372,
    cy: 190,
  },
]
