...
export const hotspots = [
  {
    ...
    isViolation: true,
    explanation:
      "Swapping a light for a fan needs a fan-rated box and a cover — exposed splices like this are a shock and fire hazard (NEC 314.27).",
    cx: 200,
    cy: 30,
  },
  {
    ...
    isViolation: true,
    explanation:
      'Stacking power strips to feed a desk setup can overload the circuit — a real fire hazard. Run a dedicated circuit instead (NEC 210.52).',
    cx: 345,
    cy: 290,
  },
  {
    ...
    isViolation: false,
    explanation:
      "A standard outlet is fine here — GFCI is only required near sinks, tubs, and countertops, not general bedroom circuits.",
    cx: 255,
    cy: 300,
  },
  {
    ...
    isViolation: false,
    explanation: "Correctly wired — this switch controls the new fan and light combo.",
    cx: 30,
    cy: 190,
  },
]
